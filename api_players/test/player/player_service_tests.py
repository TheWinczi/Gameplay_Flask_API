...
class PlayerServiceTests(unittest.TestCase):
    ...
    def test_update_existing_player(self):
        with patch('api_players.src.player.repository.player_repository.PlayerRepository.update') as mocked_repo:
    ...
    def test_delete_existing_player(self):
        with patch('api_players.src.player.repository.player_repository.PlayerRepository.delete') as mocked_repo:
            mocked_repo.return_value = PlayerRepository.SUCCESS_RETURN_VALUE
